...
var img_profile =document.querySelector('#image_profile')
const testimony =document.querySelector('#description')
const Name =document.querySelector('#Name')
const Job =document.querySelector('#Job')

const image_url_array=["../images/image-tanya.jpg","../images/image-john.jpg"]
const testtimony_array =[
...
const Speaker_info = [
    ...
    "Testimony":testtimony_array[0]
},
{
    "nom":" John Tarkpor",
    "Job":"Junior Front-end Develope", 
    "image_prodfile":image_url_array[1],
    "Testimony":testtimony_array[1]
}
]
